...
public class mobilePurchase {
	...
	public void method3() throws Throwable {
		  ...
		  File f = new File("C:\\Users\\lenovo\\eclipse-workspace\\FrameWork.Junit\\src\\test\\resources\\ExcelWrite.xlsx");
	 ...
	 public void method4() throws Throwable {
		 ...
		 text1 = Driver.findElement(By.xpath("(//div[@class='_4rR01T'])[1]")).getText();
		  ...
		  File f = new File("C:\\Users\\lenovo\\eclipse-workspace\\FrameWork.Junit\\src\\test\\resources\\ExcelWrite1.xlsx");
			Workbook W = new XSSFWorkbook();
			Sheet s = W.createSheet("Excel");
			Row r = s.createRow(0);
			Cell c = r.createCell(0);
